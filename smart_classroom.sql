...
-- Records of class
-- ----------------------------
INSERT INTO `class` VALUES ('1', '1', '仁和108', '软件工程（移动应用开发方向）', '2019', '0');
INSERT INTO `class` VALUES ('2', '1', '计C307', '移动应用开发方向', '2019', '3');
